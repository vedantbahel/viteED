                          ...
                          Row(
                            ...
                            children: [
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Report", style: TextStyle(color: Color.fromRGBO(162, 156, 244, 1), fontSize: 12),),
                                  SizedBox(height: 5,),
                                  Text("Figma 101", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25),),
                                ],
                              ),
                              Icon(Icons.close,size: 35,color: Color.fromRGBO(162, 156, 244, 1),)
                            ],
                          ),
                          SizedBox(height: 10,),
                          Container(
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text("John Doe",style: GoogleFonts.poppins(
                                    textStyle: const TextStyle(
                                        fontSize: 20,
                              ...
                              Text("44", style: GoogleFonts.poppins(
                                  textStyle: const TextStyle(
